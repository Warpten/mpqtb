...
#pragma pack(push, 1)
    struct VehicleSeatEntry {
        ...
        struct {
            uint32_t EnterAnim;
            uint32_t ExitAnim;
            uint32_t RideAnimLoop;
            uint32_t EnterAnimBone;
            uint32_t ExitAnimBone;
            uint32_t RideAnimLoopBone;
            float EnterAnimDelay;
            float ExitAnimDelay;
        } Vehicle;
        uint32_t EnterUISoundID;
        uint32_t ExitUISoundID;
        uint32_t UISkin;
        uint32_t FlagsB;
...
#pragma pack(push, 1)
    struct VehicleEntry {
        ...
        const char* MsslTrgtArcTexture;
        const char* MsslTrgtImpactTexture;
        const char* MsslTrgtImpactModel[2];
        float CameraYawOffset;
        uint32_t UILocomotionType;
        float MsslTrgtImpactTexRadius;
        uint32_t VehicleUIIndicatorID;
        uint32_t PowerDisplayID[3];
    };
#pragma pack(pop)
